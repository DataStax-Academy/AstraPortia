...
import static com.datastax.astra.web.WebUtils.getCookie;
import static com.datastax.astra.web.WebUtils.getSessionAttribute;
import static com.datastax.astra.web.WebUtils.setSessionAttribute;
...
public abstract class AbstractController {
    ...
    throws IOException {
        ...
        try {
            ctx.setVariable("dbid", apiClient.getDbId());
            ctx.setVariable("regionId", apiClient.getRegionId());
            ctx.setVariable("keyspace", apiClient.getKeyspace());
            get(req, res, ctx);
        } catch(Throwable t) {
